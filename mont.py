...
if __name__ == '__main__':
     ...
     MontezumaRevenge = ExperimentGrid(name='vpg-ocho')
     ...
     MontezumaRevenge.add('optimizer',['LARSOptimizer', 'LazyAdamGSOptimizer', 'LazyAdamOptimizer', 'MomentumWOptimizer', 'NadamOptimizer', 'PowerSignOptimizer', 'RegAdagradOptimizer', 'ShampooOptimizer'])
